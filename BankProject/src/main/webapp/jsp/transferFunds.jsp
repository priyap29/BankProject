...
<body>
	...
	<nav>
		<div class="vertical-menu">
			...
			<a href="#" class="active">Transfer Funds</a> 
	...
	<section>
		<div>
		<form action="<%=request.getContextPath()%>/transferFunds" method="post">
			<table>
				<tr>
  					<td colspan="2" style="text-align:center"><h1><b>Transfer Funds</b></h1></td>
  				</tr>
				<tr style="color: #FF0000;">
  					<td colspan="2" style="text-align:center">${errorMessage}</td>
  				</tr>
  				<tr> 
					<td style="text-align:right"><label><b>From Account:</b></label></td>
					<td>
    			...
    			<tr>
    				<td style="text-align:right"><label for="toAccount"><b>To Account:</b></label></td>
    				<td style="text-align:left"><input type="text" placeholder="Enter To Account No" name="toAcct" size="29" maxLength="10"required></td>
    			</tr>
				<tr>
